...
const Footer = () => {
  ...
  <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
        ...
        <div>
          ...
          <ul className="text-white dark:text-gray-400 font-medium">
            <li className="mb-4">
              <a href="https://github.com/sambaraks652"  target="_blank" className="hover:underline">Github</a>
            </li>
            <li>
              <a href="https://x.com/SamuelBara72816"  target="_blank"className="hover:underline">Twitter</a>
            </li>
          </ul>
        </div>
        <div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
      <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2024 <a href="#" className="hover:underline">Code_Alpha™</a>. All Rights Reserved.</span>
